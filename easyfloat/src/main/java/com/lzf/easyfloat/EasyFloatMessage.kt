...
const val WARN_CONTEXT_ACTIVITY =
    "Context exception. Activity float need to pass in a activity context."
const val WARN_CONTEXT_REQUEST =
    "Context exception. Request Permission need to pass in a activity context."
