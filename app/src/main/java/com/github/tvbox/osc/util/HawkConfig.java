...
public class HawkConfig {
    ...
    public static final String Had_show_download_tips = "Had_show_download_tips";
    ...
    public static final String LIVE_CHANELE_COLLECTD = "live_chanele_collectd";//收藏的频道列表
    ...
    public static final String PLAY_TYPE = "play_type";//0 系统 1 ijk 2 exo 10 MXPlayer 3 Aliplayer
