                ...
                if (params.get("do") != null && mDataReceiver != null) {
                    ...
                    switch (action) {
                        ...
                        case "pushStore": {
                            ...
                            mDataReceiver.onStorePushReceive(name,
                                    url);
                            break;
                        }
                        case "livePush":{
                            String name = params.get("live_name").trim();
                            String url = params.get("live_address").trim();
                            mDataReceiver.onLiveSourceReceive(name,
                                    url);
                            break;
                        }
